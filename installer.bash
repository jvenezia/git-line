...
SCRIPT_FILES="git-line_utils.bash git-line git-line-clean git-line-close git-line-fixup git-line-remove git-line-squash git-line-start git-line-switch git-line-update"
