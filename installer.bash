...
SCRIPT_FILES="git-line_utils.bash git-line git-line-close git-line-fixup git-line-nuke git-line-remove git-line-squash git-line-start git-line-switch git-line-update"
